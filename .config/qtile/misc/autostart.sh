...
feh --bg-fill /home/julian/Pictures/Wallpapers/river-boat.jpg &
...
[[ $(is_running 'gnome-settings-daemon') ]] || gnome-settings-daemon &
...
if ! [[ $RUNNING_QTILE ]]; then
  [[ $(is_running 'picom') ]] || ~/picom/build/src/picom &
fi;
