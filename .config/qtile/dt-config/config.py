...
myTerm = "tilix"                             # My terminal of choice
myConfig = "/home/julian/.config/qtile/config.py"    # The Qtile config file location
...
keys = [
         ...
         Key([mod, "shift"], "d",
             lazy.spawn("dmenu_run -r -p 'dmenu' -h 23 -sb '#6e5991' -nb '#000000' -nf '#ffffff'"),
...
colors = [["#292d3e", "#292d3e"], # panel background
          ...
          ["#6e5991", "#6e5991"], # border line color for other tab and odd widgets
...
def init_widgets_list():
    widgets_list = [
              ...
              widget.Image(
                       ...
                       mouse_callbacks = {'Button1': lambda qtile: qtile.cmd_spawn("dmenu_run -r -p 'dmenu' -h 23 -sb '#6e5991' -nb '#000000' -nf '#ffffff'")},
                       padding_y = 10,
                       ),
              widget.GroupBox(
                       font = "Ubuntu Bold",
